...
space = {
    ...
    'clusters_selected'          : hp.choice('c_selected',[4,8,12,16,32,64]),
    'learning_rate'              : hp.choice('l_rate',[0.3,0.2,0.1,0.01,.05]),
    ...
    'learning_rate_decay_type'   : hp.choice('l_decay_type',['linear','geometric',None]),
    'create_pomdp'               : False,
    'do_recurrence'              : False,
...
trials = MongoTrials(mongodb_machine + 'cartpole_clustertest_again/jobs',exp_key='cartpole_hyperopt_nn_clustertest')
